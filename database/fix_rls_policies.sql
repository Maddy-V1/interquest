-- Quick fix for Row Level Security policies
-- Run this in Supabase SQL Editor to fix the round control issue
...
-- Verify the setup
SELECT 'Setup complete! Round config table created with proper RLS policies.' as status;